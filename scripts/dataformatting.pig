REGISTER /home/cloudera/project/lib/piggybank.jar;

DEFINE XPath org.apache.pig.piggybank.evaluation.xml.XPath();
 
A =  LOAD '/user/cloudera/project/batch${batchid}/web/' using org.apache.pig.piggybank.storage.XMLLoader('record') as (x:chararray);
...
STORE B INTO '/user/cloudera/project/batch${batchid}/formattedweb/' USING PigStorage(',');
