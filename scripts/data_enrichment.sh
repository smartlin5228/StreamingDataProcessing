...
VALIDDIR=/home/cloudera/project/processed_dir/valid/batch_$batchid
INVALIDDIR=/home/cloudera/project/processed_dir/invalid/batch_$batchid

echo "Running hive script for data enrichment and filtering..." >> $LOGFILE

hive -hiveconf batchid=$batchid -f /home/cloduera/project/scripts/data_enrichment.hql
